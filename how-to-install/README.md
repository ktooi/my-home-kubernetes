...
1. [Install cri-o](./install_crio.md)
2. [Install and config prerequirements](./install_and_config_prerequirements.md)
3. [Setup Master Node](./setup_masternode.md)
4. [Install cilium](./install_cilium.md)
...
* [Upgrade metallb](./upgrade_metallb.md)
